...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid address" do
    valid_addresses=%w[user@example.com USER@example.COM US-ER@foo.bar.org first.last@foo.jp alice+bob@baz.cn]
  ...
  test "email validation should reject invalid address" do
    invalid_addresses=%w[user@exam@le,com user_at_foo.org user.name@example. foo@bar_baz.com foo@bar+baz.com]
